...
The accelerator device present itself as a "uacce" object, which export as
...
enum uacce_qfrt {
	...
	UACCE_QFRT_SS,		/* static share memory (for non-sva devices) */
	UACCE_QFRT_MAX,
};
...
If the device works in modes other than UACCE_DEV_NOIOMMU, *uacce* will set its
...
achieve a similar goal. But we gave up finally. Both VFIO and IB have extra
