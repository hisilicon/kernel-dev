...
enum hclgevf_opcode_type {
	...
	/* MAC commond */
	HCLGEVF_OPC_CONFIG_MAC_MODE	= 0x0301,
	HCLGEVF_OPC_QUERY_LINK_STATUS	= 0x0307,

	/* MACSEC command */

	/* ETS/scheduler commands */
	HCLGEVF_OPC_TM_PG_TO_PRI_LINK	= 0x0804,
	HCLGEVF_OPC_TM_QS_TO_PRI_LINK     = 0x0805,
	HCLGEVF_OPC_TM_NQ_TO_QS_LINK      = 0x0806,
	HCLGEVF_OPC_TM_RQ_TO_QS_LINK      = 0x0807,
	HCLGEVF_OPC_TM_PORT_WEIGHT        = 0x0808,
	HCLGEVF_OPC_TM_PG_WEIGHT          = 0x0809,
	HCLGEVF_OPC_TM_QS_WEIGHT          = 0x080A,
	HCLGEVF_OPC_TM_PRI_WEIGHT         = 0x080B,
	HCLGEVF_OPC_TM_PRI_C_SHAPPING     = 0x080C,
	HCLGEVF_OPC_TM_PRI_P_SHAPPING     = 0x080D,
	HCLGEVF_OPC_TM_PG_C_SHAPPING      = 0x080E,
	HCLGEVF_OPC_TM_PG_P_SHAPPING      = 0x080F,
	HCLGEVF_OPC_TM_PORT_SHAPPING      = 0x0810,
	HCLGEVF_OPC_TM_PG_SCH_MODE_CFG    = 0x0812,
	HCLGEVF_OPC_TM_PRI_SCH_MODE_CFG   = 0x0813,
	HCLGEVF_OPC_TM_QS_SCH_MODE_CFG    = 0x0814,
	HCLGEVF_OPC_TM_BP_TO_QSET_MAPPING = 0x0815,

	/* PTP command */
	/* TQP management command */
	HCLGEVF_OPC_SET_TQP_MAP		= 0x0A01,

	/* TQP command */
	HCLGEVF_OPC_CFG_TX_QUEUE	= 0x0B01,
	HCLGEVF_OPC_QUERY_TX_POINTER	= 0x0B02,
	HCLGEVF_OPC_QUERY_TX_STATUS	= 0x0B03,
	HCLGEVF_OPC_CFG_RX_QUEUE	= 0x0B11,
	HCLGEVF_OPC_QUERY_RX_POINTER	= 0x0B12,
	HCLGEVF_OPC_QUERY_RX_STATUS	= 0x0B13,
	HCLGEVF_OPC_STASH_RX_QUEUE_LRO	= 0x0B16,
	HCLGEVF_OPC_CFG_RX_QUEUE_LRO	= 0x0B17,
	HCLGEVF_OPC_CFG_COM_TQP_QUEUE	= 0x0B20,
	HCLGEVF_OPC_CFG_INIT_RCB	= 0x0B21,
	HCLGEVF_OPC_RESET_TQP_QUEUE	= 0x0B22,
	...
	/* Interrupts cmd */
	HCLGEVF_OPC_ADD_RING_TO_VECTOR	= 0x1503,
	HCLGEVF_OPC_DEL_RING_TO_VECTOR	= 0x1504,
...
void hclgevf_cmd_setup_basic_desc(struct hclgevf_desc *desc,
				  ...
				  bool is_read);
void hclgevf_destroy_cmd_queue(struct hclgevf_hw *hw);
void print_desc(struct hclgevf_desc *desc);
void hclgevf_enable_vector(struct hclgevf_misc_vector *vector, bool enable);
#endif
