...
/* SMMU tracepoints */
EXPORT_TRACEPOINT_SYMBOL_GPL(smmu_evt);
EXPORT_TRACEPOINT_SYMBOL_GPL(smmu_resume);
EXPORT_TRACEPOINT_SYMBOL_GPL(smmu_cdsync);
EXPORT_TRACEPOINT_SYMBOL_GPL(smmu_cdwrite);
EXPORT_TRACEPOINT_SYMBOL_GPL(smmu_l1cdwrite);
