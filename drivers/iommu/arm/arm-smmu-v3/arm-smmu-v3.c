...
static int arm_smmu_device_hw_probe(struct arm_smmu_device *smmu)
{
	...
	/*
	 * If S1 only or both S1 and S2 are supported, check whether we can
	 * enable BTM. This will be useful when CPU shares the page tables
	 * with SMMUv3(eg: vSVA)
	 */

	if ((reg & IDR0_S1P) || ((reg & IDR0_S1P) && (reg & IDR0_S2P))) {
		/*
