...
static const int l3c_cfgen_map[] = { HISI_L3C_BANK0_CFGEN, HISI_L3C_BANK1_CFGEN,
...
void hisi_enable_l3c_counter(struct hisi_l3c_data *l3c_hwmod_data, int idx)
{
	struct device_node *djtag_node;
	u32 value = 0;
	int cfg_en;
