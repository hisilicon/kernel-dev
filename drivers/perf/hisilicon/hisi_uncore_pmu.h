...
void hisi_pmu_enable_counter(struct hisi_hwmod_unit *,
				enum hisi_hwmod_type, int);
void hisi_pmu_disable_counter(struct hisi_hwmod_unit *,
				enum hisi_hwmod_type, int);
int hisi_pmu_write_counter(struct hisi_hwmod_unit *,
				enum hisi_hwmod_type, int, u32);
void hisi_pmu_write_evtype(int, enum hisi_hwmod_type, u32);
...
void hisi_uncore_pmu_write_evtype(struct hisi_hwmod_unit *,
					  enum hisi_hwmod_type,
							int, u32);
