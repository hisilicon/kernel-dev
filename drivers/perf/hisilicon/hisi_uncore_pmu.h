...
u64 hisi_pmu_event_update(struct perf_event *,
				struct hw_perf_event *, int);
void hisi_pmu_enable_counter(struct hisi_pmu *, int);
void hisi_pmu_disable_counter(struct hisi_pmu *, int);
int hisi_pmu_write_counter(struct hisi_pmu *, int, u32);
void hisi_pmu_write_evtype(struct hisi_pmu *, int, u32);
int hisi_pmu_get_event_idx(struct hisi_pmu *);
void hisi_pmu_clear_event_idx(struct hisi_pmu *, int);
...
void hisi_uncore_pmu_write_evtype(struct hisi_pmu *, int, u32);
