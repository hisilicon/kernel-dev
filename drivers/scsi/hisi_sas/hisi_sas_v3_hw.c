...
static irqreturn_t phy_up_v3_hw(int phy_no, struct hisi_hba *hisi_hba)
{
	...
	/* Call pm_runtime_put_sync() or pm_runtime_put() with pairs in
	 * hisi_sas_phyup_pm_work(). It is a hardirq context as follow so use
	 * pm_runtime_put() here to avoid sleeping in hardirq context
	 */
