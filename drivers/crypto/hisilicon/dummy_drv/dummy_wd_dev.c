 ...
 *
 * It creates MAX_DEV platform devices with MAX_QUEUE queue for each.
 * When the queue is gotten, a kernel thread is created and handle request
 * put into the queue by the user application.
 */
