...
static int blk_mq_init_aux_tags(struct request_queue *queue, unsigned int cmd_extra_size)
{
...
int blk_mq_init_aux(struct request_queue *q, unsigned int cmd_extra_size)
{
	int ret;
