 ...
 *
 * Allocate a PASID for the current process address space, and use it to attach
 * this process to all devices in the container. Devices can then tag their DMA
 ...
 * issued with the same parameters.
 */
