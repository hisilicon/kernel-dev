...
static void metricgroup__print_pmu_event(struct pmu_event *pe, bool metricgroups, char *filter, bool raw,
				bool details, struct rblist *groups, struct strlist *metriclist)
{
	const char *g;
...
static int metricgroup__add_metric_pmu_event(struct pmu_event *pe, const char *metric, struct strbuf *events, struct list_head *group_list)
{
